...
🔗 **Demo:** https://alexbrunoduarte.com.br (substitua pelo seu domínio final)
...
```bash
# clone o repositório
git clone https://github.com/alexb7z/portfolio.git
cd portfolio
...
git branch -M main
git remote add origin https://github.com/alexb7z/portfolio.git
